const tag = 'RTL'; // these are my tags: comment, blockquote, and objection. Use whatever you want and then update the CSS style accordingly

function applyAndHideTag(tag) {
...
const mutationObserver = new MutationObserver(() => applyAndHideTag(tag))
